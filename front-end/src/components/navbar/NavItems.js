...
const NavItems = () => {
  return (
    <>
    <AnchorLink href='#home' className="uppercase text-sm px-3 rounded transition py-2 text-light/70 hover:text-light hover:bg-cyan-600 w-full md:hover:bg-transparent md:hover:text-cyan-600">Home</AnchorLink>
